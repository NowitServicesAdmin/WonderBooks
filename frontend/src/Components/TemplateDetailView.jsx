...
export const TemplateDetail = () => {
    ...
    return (
        <section className="relative w-full overflow-auto rounded-3xl border border-[#e4e0ef] bg-linear-to-br from-[#fbfaff] via-[#f8f6fc] to-[#f0edf7]
        max-h-full">
    ...
    ================================================= */}
                        ...
                        <div className="relative z-20 h-90 w-[92%] overflow-hidden rounded-[22px] bg-white shadow-[0_9px_24px_rgba(35,35,70,0.14)] sm:h-160">
                            <HTMLFlipBook ref={bookRef} width={600} height={640} size="stretch" minWidth={300} maxWidth={1100} minHeight={420} maxHeight={700} showCover={false} usePortrait={false} mobileScrollSupport={false} drawShadow={true} maxShadowOpacity={0.28} flippingTime={650} startPage={0} onFlip={handleFlip} className="story-book h-full w-full" style={{ margin: 0 }}>
                    ...
                    ================================================= */}
                                        ...
                                        {leaf.type === "image" ? (
                                            <div className="relative h-full w-full overflow-hidden bg-white">
                                                <img src={leaf.page.image} alt="" draggable={false} className="h-full w-full object-cover" />
        ...
        ================================================= */}
            ...
            LEFT ARROW
        ================================================= */}
                            <button type="button" onClick={goPrevPage} disabled={isFirstPage} aria-label="Previous page" className="absolute left-5 top-1/2 z-100 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white text-[#5d2bc5] shadow-[0_7px_22px_rgba(50,40,100,0.20)] transition-all hover:scale-105 hover:bg-[#f7f3ff] disabled:pointer-events-none disabled:opacity-20">
                                <ChevronLeft size={25} />
                            </button>
        ...
        ================================================= */}
                            ...
                            <button type="button" onClick={goNextPage} disabled={isLastPage} aria-label="Next page" className="absolute right-5 top-1/2 z-100 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white text-[#5d2bc5] shadow-[0_7px_22px_rgba(50,40,100,0.20)] transition-all hover:scale-105 hover:bg-[#f7f3ff] disabled:pointer-events-none disabled:opacity-20">
    ...
    ================================================= */}
            ...
            {pageNavOpen && (
                <div className="absolute inset-0 z-200 flex items-center justify-center bg-[#29254d]/20 p-6 backdrop-blur-[3px]" onClick={() => setPageNavOpen(false)}>
                    <div className="relative max-h-155 w-full max-w-150 overflow-y-auto rounded-3xl border border-[#e5dff2] bg-white p-4 shadow-[0_30px_80px_rgba(40,30,80,0.28)] sm:p-6" onClick={(event) => event.stopPropagation()}>
